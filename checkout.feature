            ...
            Quando preencher os campos <nome>, <e-mail>, <senha> e clicar no botão "cadastrar"
            Então o cadastro deve ser concluído com sucesso
...
E eu clicar no botão "cadastrar"
Então deve exibir uma mensagem de alerta informando "Preencha todos os campos obrigatórios"